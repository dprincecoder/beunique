  ...
  return (
    <>
      ...
      <section className="w-full flex flex-col items-center justify-center p-0 m-0 z-30 font-inter scrollbar scrollbar-track-[#ACB2BE] scrollbar-thumb-black scrollbar-corner-red-500 scrollbar-w-4 scrollbar-track-rounded-md scrollbar-thumb-rounded-md scrollbar-corner-rounded-md">
        <section className="w-[95%] mx-auto bg-white dark:bg-white">
        ...
        <section className="w-[95%] mx-auto bg-white dark:bg-white text-black dark:text-black p-0 m-0 my-4">
      ...
      "
              ...
              <section className="w-full flex flex-col sm2:flex-row sm2:flex-wrap justify-start items-start gap-6">
                {allProducts &&
        ...
        <section className="w-[95%] p-0 m-0 my-6 flex flex-col items-start">
