          ...
          <section className="w-fit md:w-[70%] md2:w-[60%] flex flex-row items-center justify-between">
            ...
            <section className="w-fit block space-x-4 sm:space-x-8">
              ...
              >
                ...
                >
                  <Menu.Items className="absolute right-0 mt-3 w-[300px] origin-center divide-y divide-gray-600 rounded-md bg-white shadow-md ring-1 ring-black ring-opacity-5 focus:outline-none">
