...
const Countdown = ({ targetDate }) => {
  ...
  const ExpiredNotice = () => {
    ...
    return (
      <section className="grid place-items-center">
        <h3 className="text-xl text-red-500 font-semibold mb-2">Expired!!!</h3>
        <p className="text-[14px]">Please select a future date and time.</p>
      </section>
    );
  };
  ...
  const DateTimeDisplay = ({ value, type, isDanger }) => {
    return (
      ...
      >
        <h2 className="text-[30px] font-anybody">{value ? value : 0}</h2>
