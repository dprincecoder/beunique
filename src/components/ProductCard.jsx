        ...
        <section className="w-full relative inline-block group duration-300 mt-4">
          ...
          <section className="relative">
            ...
            <button
              ...
              onClick={() => handleSelectSizeOpen(items?.id)}
            >
              Quick Add
            </button>
                      ...
                      if (size.selected) {
                        ...
                        return (
                          <section
                            ...
                            onClick={() => handleSize(size.id, items?.id)}
                          >
                            {size.size}
                          </section>
                        );
          ...
          <section className="w-full flex items-start justify-between mt-5">
            <Link
              to={`/p?type=${items?.category_slug}&item?=${items?.slug_name}`}
              className="w-full"
            >
